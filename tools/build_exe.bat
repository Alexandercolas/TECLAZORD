...
python -m PyInstaller --name TeclazoRD --onedir --windowed --contents-directory . --icon "assets\icon\teclazo_rd.ico" --version-file "tools\version_info.txt" --add-data "assets;assets" --noconfirm main.py
if errorlevel 1 goto :error
